...
import { CustomField, defaultDeSerializers, DefaultDeSerializers, DeSerializers, AllFields, entityBuilder, EntityBuilderType, EntityApi, FieldBuilder, OrderableEdmTypeField, CollectionField, EnumField, OneToManyLink, OneToOneLink } from '@sap-cloud-sdk/odata-v4';
export class PeopleApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
      People<
        DeSerializersT
      >, 
  ...
  _addNavigationProperties(
      linkedApis: [
        PeopleApi<DeSerializersT>,PhotosApi<DeSerializersT>
      ]): this {
        this.navigationPropertyFields = {
          FRIENDS: new OneToManyLink(
              'Friends',
              this,
              linkedApis[0]
            ),
          PHOTO: new OneToOneLink(
              'Photo',
              this,
              linkedApis[1]
            )
  ...
  requestBuilder(): PeopleRequestBuilder<
    DeSerializersT
  > {
  ...
  private _schema?: {
    USER_NAME: OrderableEdmTypeField<People<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
FIRST_NAME: OrderableEdmTypeField<People<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LAST_NAME: OrderableEdmTypeField<People<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
EMAILS: CollectionField<People<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ADDRESS_INFO: CollectionField<People<DeSerializers>, DeSerializersT, Location, true, true>,
GENDER: EnumField<People<DeSerializers>, DeSerializersT, PersonGender, true, true>,
CONCURRENCY: OrderableEdmTypeField<People<DeSerializers>, DeSerializersT, 'Edm.Int64', false, true>,
/**
 * Static representation of the one-to-many navigation property {@link friends} for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */
 ...
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */
ADDRESS_INFO: fieldBuilder.buildCollectionField('AddressInfo', Location, true),
/**
 ...
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */
CONCURRENCY: fieldBuilder.buildEdmTypeField('Concurrency', 'Edm.Int64', false),
...this.navigationPropertyFields,
/**
 * 
 * All fields selector.
