...
class MicrosoftODataServiceSampleTrippinInMemoryModelsService {
    ...
    get functionImports() {
        return { getNearestAirport: (parameter) => (0, function_imports_1.getNearestAirport)(parameter, this.deSerializers) };
    }
    get actionImports() {
        return { resetDataSource: (parameter) => (0, action_imports_1.resetDataSource)(parameter, this.deSerializers) };
    }
    get batch() {
