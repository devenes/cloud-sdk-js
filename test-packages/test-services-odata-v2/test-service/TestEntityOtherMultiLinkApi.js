...
class TestEntityOtherMultiLinkApi {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(TestEntityOtherMultiLink_1.TestEntityOtherMultiLink, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
             ...
             */
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', TestEntityOtherMultiLink_1.TestEntityOtherMultiLink)
            };
        }
        return this._schema;
    }
