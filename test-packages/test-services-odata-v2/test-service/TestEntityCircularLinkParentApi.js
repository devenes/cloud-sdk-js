...
class TestEntityCircularLinkParentApi {
    ...
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            TO_CHILD: new odata_v2_1.Link('to_Child', this, linkedApis[0])
        };
        return this;
    }
    requestBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(TestEntityCircularLinkParent_1.TestEntityCircularLinkParent, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
             ...
             */
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', TestEntityCircularLinkParent_1.TestEntityCircularLinkParent)
            };
        }
        return this._schema;
    }
