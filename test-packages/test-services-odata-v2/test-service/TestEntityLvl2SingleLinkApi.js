...
class TestEntityLvl2SingleLinkApi {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
             ...
             */
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink)
            };
        }
        return this._schema;
    }
