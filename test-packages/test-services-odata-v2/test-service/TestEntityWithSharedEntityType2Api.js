...
class TestEntityWithSharedEntityType2Api {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
             ...
             */
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', TestEntityWithSharedEntityType2_1.TestEntityWithSharedEntityType2)
            };
        }
        return this._schema;
    }
