...
class TestEntityApi {
    ...
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            ...
            TO_OTHER_MULTI_LINK: new odata_v2_1.Link('to_OtherMultiLink', this, linkedApis[1]),
            TO_SINGLE_LINK: new odata_v2_1.OneToOneLink('to_SingleLink', this, linkedApis[2])
        };
        return this;
    }
    requestBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(TestEntity_1.TestEntity, this.deSerializers);
        }
