 ...
 */
export class TestEntityCircularLinkChildRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<TestEntityCircularLinkChild<T>, T> {
  /**
  ...
  getByKey(keyProperty: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<TestEntityCircularLinkChild<T>, T> {
    return new GetByKeyRequestBuilder<TestEntityCircularLinkChild<T>, T>(this.entityApi, { KeyProperty: keyProperty });
  }
  ...
  getAll(): GetAllRequestBuilder<TestEntityCircularLinkChild<T>, T> {
    return new GetAllRequestBuilder<TestEntityCircularLinkChild<T>, T>(this.entityApi);
  }
  ...
  create(entity: TestEntityCircularLinkChild<T>): CreateRequestBuilder<TestEntityCircularLinkChild<T>, T> {
    return new CreateRequestBuilder<TestEntityCircularLinkChild<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: TestEntityCircularLinkChild<T>): UpdateRequestBuilder<TestEntityCircularLinkChild<T>, T> {
    return new UpdateRequestBuilder<TestEntityCircularLinkChild<T>, T>(this.entityApi, entity);
  }
  ...
  delete(keyPropertyOrEntity: any): DeleteRequestBuilder<TestEntityCircularLinkChild<T>, T> {
    return new DeleteRequestBuilder<TestEntityCircularLinkChild<T>, T>(this.entityApi, keyPropertyOrEntity instanceof TestEntityCircularLinkChild ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity! });
  }
}
