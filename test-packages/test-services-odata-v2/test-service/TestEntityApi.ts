...
import { CustomField, defaultDeSerializers, DefaultDeSerializers, DeSerializers, AllFields, entityBuilder, EntityBuilderType, EntityApi, FieldBuilder, Time, OrderableEdmTypeField, EdmTypeField, Link, OneToOneLink } from '@sap-cloud-sdk/odata-v2';
...
TIME_PROPERTY: OrderableEdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
DATE_TIME_PROPERTY: OrderableEdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
