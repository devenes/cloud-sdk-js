...
class TestEntityMultiLinkApi {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(TestEntityMultiLink_1.TestEntityMultiLink, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
             ...
             */
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', TestEntityMultiLink_1.TestEntityMultiLink)
            };
        }
        return this._schema;
    }
