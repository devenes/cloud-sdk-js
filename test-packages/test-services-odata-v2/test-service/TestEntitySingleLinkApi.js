...
class TestEntitySingleLinkApi {
    ...
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            ...
            TO_SINGLE_LINK: new odata_v2_1.OneToOneLink('to_SingleLink', this, linkedApis[1])
        };
        return this;
    }
    requestBuilder() {
        return new TestEntitySingleLinkRequestBuilder_1.TestEntitySingleLinkRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(TestEntitySingleLink_1.TestEntitySingleLink, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
             ...
             */
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', TestEntitySingleLink_1.TestEntitySingleLink)
            };
        }
        return this._schema;
    }
