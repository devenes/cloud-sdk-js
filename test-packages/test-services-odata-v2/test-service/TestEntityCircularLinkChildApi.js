...
class TestEntityCircularLinkChildApi {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(TestEntityCircularLinkChild_1.TestEntityCircularLinkChild, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
             ...
             */
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', TestEntityCircularLinkChild_1.TestEntityCircularLinkChild)
            };
        }
        return this._schema;
    }
