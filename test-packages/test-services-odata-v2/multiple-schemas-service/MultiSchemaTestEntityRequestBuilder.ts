 ...
 */
export class MultiSchemaTestEntityRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<MultiSchemaTestEntity<T>, T> {
  /**
  ...
  getByKey(keyProperty: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<MultiSchemaTestEntity<T>, T> {
    return new GetByKeyRequestBuilder<MultiSchemaTestEntity<T>, T>(this.entityApi, { KeyProperty: keyProperty });
  }
  ...
  getAll(): GetAllRequestBuilder<MultiSchemaTestEntity<T>, T> {
    return new GetAllRequestBuilder<MultiSchemaTestEntity<T>, T>(this.entityApi);
  }
  ...
  create(entity: MultiSchemaTestEntity<T>): CreateRequestBuilder<MultiSchemaTestEntity<T>, T> {
    return new CreateRequestBuilder<MultiSchemaTestEntity<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: MultiSchemaTestEntity<T>): UpdateRequestBuilder<MultiSchemaTestEntity<T>, T> {
    return new UpdateRequestBuilder<MultiSchemaTestEntity<T>, T>(this.entityApi, entity);
  }
  ...
  delete(keyPropertyOrEntity: any): DeleteRequestBuilder<MultiSchemaTestEntity<T>, T> {
    return new DeleteRequestBuilder<MultiSchemaTestEntity<T>, T>(this.entityApi, keyPropertyOrEntity instanceof MultiSchemaTestEntity ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity! });
  }
}
