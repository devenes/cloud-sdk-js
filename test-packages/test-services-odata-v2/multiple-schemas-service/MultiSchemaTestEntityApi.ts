...
export class MultiSchemaTestEntityApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof MultiSchemaTestEntity, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(MultiSchemaTestEntity, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    KEY_PROPERTY: OrderableEdmTypeField<MultiSchemaTestEntity<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
