...
export declare function boundTestService<BinaryT = string, BooleanT = boolean, ByteT = number, DecimalT = BigNumber, DoubleT = number, FloatT = number, Int16T = number, Int32T = number, Int64T = BigNumber, GuidT = string, SByteT = number, SingleT = number, StringT = string, AnyT = any, DateTimeOffsetT = Moment, DateT = Moment, DurationT = Duration, TimeOfDayT = Time, EnumT = any>(deSerializers?: Partial<DeSerializers<BinaryT, BooleanT, ByteT, DecimalT, DoubleT, FloatT, Int16T, Int32T, Int64T, GuidT, SByteT, SingleT, StringT, AnyT, DateTimeOffsetT, DateT, DurationT, TimeOfDayT, EnumT>>): BoundTestService<DeSerializers<BinaryT, BooleanT, ByteT, DecimalT, DoubleT, FloatT, Int16T, Int32T, Int64T, GuidT, SByteT, SingleT, StringT, AnyT, DateTimeOffsetT, DateT, DurationT, TimeOfDayT, EnumT>>;
declare class BoundTestService<DeSerializersT extends DeSerializers = DefaultDeSerializers> {
    private apis;
    ...
    get functionImports(): {
        ...
        returnInt: (parameter: ReturnIntParameters<DeSerializersT>) => import("@sap-cloud-sdk/odata-v4").FunctionImportRequestBuilder<DeSerializersT, ReturnIntParameters<DeSerializersT>, number | null>;
        ...
        getByKey: (parameter: GetByKeyParameters<DeSerializersT>) => import("@sap-cloud-sdk/odata-v4").FunctionImportRequestBuilder<DeSerializersT, GetByKeyParameters<DeSerializersT>, import("./TestEntity").TestEntity<DefaultDeSerializers> | null>;
    ...
    get actionImports(): {
        createTestEntityById: (parameter: CreateTestEntityByIdParameters<DeSerializersT>) => import("@sap-cloud-sdk/odata-v4").ActionImportRequestBuilder<DeSerializersT, CreateTestEntityByIdParameters<DeSerializersT>, import("./TestEntity").TestEntity<DefaultDeSerializers> | null>;
        createTestEntityByIdReturnId: (parameter: CreateTestEntityByIdReturnIdParameters<DeSerializersT>) => import("@sap-cloud-sdk/odata-v4").ActionImportRequestBuilder<DeSerializersT, CreateTestEntityByIdReturnIdParameters<DeSerializersT>, number | null>;
    };
