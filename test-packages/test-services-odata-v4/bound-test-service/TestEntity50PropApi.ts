...
import { CustomField, defaultDeSerializers, DefaultDeSerializers, DeSerializers, AllFields, entityBuilder, EntityBuilderType, EntityApi, FieldBuilder, Time, OrderableEdmTypeField } from '@sap-cloud-sdk/odata-v4';
export class TestEntity50PropApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
      TestEntity50Prop<
        DeSerializersT
      >, 
  ...
  requestBuilder(): TestEntity50PropRequestBuilder<
    DeSerializersT
  > {
  ...
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(TestEntity50Prop, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    KEY_TEST_ENTITY_50_PROP: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Int32', false, true>,
STRING_PROPERTY_1: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
GUID_PROPERTY_1: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Guid', true, true>,
BOOLEAN_PROPERTY_1: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
INT_64_PROPERTY_1: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Int64', true, true>,
DOUBLE_PROPERTY_1: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Double', true, true>,
DECIMAL_PROPERTY_1: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Decimal', true, true>,
DATE_PROPERTY_1: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Date', true, true>,
TIME_OF_DAY_PROPERTY_1: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.TimeOfDay', true, true>,
DATA_TIME_OFFSET_DATA_TIME_PROPERTY_1: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
DATA_TIME_OFFSET_TIMESTAMP_PROPERTY_1: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
STRING_PROPERTY_2: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
GUID_PROPERTY_2: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Guid', true, true>,
BOOLEAN_PROPERTY_2: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
INT_64_PROPERTY_2: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Int64', true, true>,
DOUBLE_PROPERTY_2: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Double', true, true>,
DECIMAL_PROPERTY_2: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Decimal', true, true>,
DATE_PROPERTY_2: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Date', true, true>,
TIME_OF_DAY_PROPERTY_2: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.TimeOfDay', true, true>,
DATA_TIME_OFFSET_DATA_TIME_PROPERTY_2: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
DATA_TIME_OFFSET_TIMESTAMP_PROPERTY_2: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
STRING_PROPERTY_3: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
GUID_PROPERTY_3: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Guid', true, true>,
BOOLEAN_PROPERTY_3: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
INT_64_PROPERTY_3: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Int64', true, true>,
DOUBLE_PROPERTY_3: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Double', true, true>,
DECIMAL_PROPERTY_3: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Decimal', true, true>,
DATE_PROPERTY_3: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Date', true, true>,
TIME_OF_DAY_PROPERTY_3: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.TimeOfDay', true, true>,
DATA_TIME_OFFSET_DATA_TIME_PROPERTY_3: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
DATA_TIME_OFFSET_TIMESTAMP_PROPERTY_3: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
STRING_PROPERTY_4: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
GUID_PROPERTY_4: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Guid', true, true>,
BOOLEAN_PROPERTY_4: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
INT_64_PROPERTY_4: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Int64', true, true>,
DOUBLE_PROPERTY_4: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Double', true, true>,
DECIMAL_PROPERTY_4: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Decimal', true, true>,
DATE_PROPERTY_4: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Date', true, true>,
TIME_OF_DAY_PROPERTY_4: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.TimeOfDay', true, true>,
DATA_TIME_OFFSET_DATA_TIME_PROPERTY_4: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
DATA_TIME_OFFSET_TIMESTAMP_PROPERTY_4: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
STRING_PROPERTY_5: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
GUID_PROPERTY_5: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Guid', true, true>,
BOOLEAN_PROPERTY_5: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
INT_64_PROPERTY_5: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Int64', true, true>,
DOUBLE_PROPERTY_5: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Double', true, true>,
DECIMAL_PROPERTY_5: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Decimal', true, true>,
DATE_PROPERTY_5: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.Date', true, true>,
TIME_OF_DAY_PROPERTY_5: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.TimeOfDay', true, true>,
DATA_TIME_OFFSET_DATA_TIME_PROPERTY_5: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
DATA_TIME_OFFSET_TIMESTAMP_PROPERTY_5: OrderableEdmTypeField<TestEntity50Prop<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
