...
import { batch, changeset } from './BatchRequest';
  ...
  export function boundTestService<BinaryT = string,
BooleanT = boolean,
ByteT = number,
DecimalT = BigNumber,
DoubleT = number,
...
EnumT>> = defaultDeSerializers as any
  ):BoundTestService<DeSerializers<BinaryT,
BooleanT,
ByteT,
DecimalT,
DoubleT,
...
EnumT>>  
  {
  return new BoundTestService(mergeDefaultDeSerializersWith(deSerializers))
  } 
class BoundTestService<DeSerializersT extends DeSerializers = DefaultDeSerializers> {
    ...
    get testEntityWithMultipleKeysApi(): TestEntityWithMultipleKeysApi<DeSerializersT> { 
        return this.initApi('testEntityWithMultipleKeysApi', TestEntityWithMultipleKeysApi)    
      }
    ...
    get testEntity50PropApi(): TestEntity50PropApi<DeSerializersT> { 
      ...
      get functionImports( ) {
        return {returnSapCloudSdk:(parameter:ReturnSapCloudSdkParameters<DeSerializersT>)=>returnSapCloudSdk(parameter,this.deSerializers),concatStrings:(parameter:ConcatStringsParameters<DeSerializersT>)=>concatStrings(parameter,this.deSerializers),returnInt:(parameter:ReturnIntParameters<DeSerializersT>)=>returnInt(parameter,this.deSerializers),returnCollection:(parameter:ReturnCollectionParameters<DeSerializersT>)=>returnCollection(parameter,this.deSerializers),getByKey:(parameter:GetByKeyParameters<DeSerializersT>)=>getByKey(parameter,this.deSerializers),getAll:(parameter:GetAllParameters<DeSerializersT>)=>getAll(parameter,this.deSerializers)}
      }
