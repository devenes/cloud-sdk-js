 ...
 */
import { edmToTs, FunctionImportRequestBuilder, DeSerializers, transformReturnValueForEdmType, transformReturnValueForEdmTypeList, transformReturnValueForEntity, transformReturnValueForEntityList, DefaultDeSerializers, defaultDeSerializers, FunctionImportParameter } from '@sap-cloud-sdk/odata-v4';
import { boundTestService } from './service';
 ...
 */
export function returnSapCloudSdk<DeSerializersT extends DeSerializers = DefaultDeSerializers>(parameters: ReturnSapCloudSdkParameters<DeSerializersT>, deSerializers: DeSerializersT = defaultDeSerializers as any): FunctionImportRequestBuilder<DeSerializersT, ReturnSapCloudSdkParameters<DeSerializersT>, string | null> {
  const params = {
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
export function concatStrings<DeSerializersT extends DeSerializers = DefaultDeSerializers>(parameters: ConcatStringsParameters<DeSerializersT>, deSerializers: DeSerializersT = defaultDeSerializers as any): FunctionImportRequestBuilder<DeSerializersT, ConcatStringsParameters<DeSerializersT>, string | null> {
  const params = {
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
export function returnInt<DeSerializersT extends DeSerializers = DefaultDeSerializers>(parameters: ReturnIntParameters<DeSerializersT>, deSerializers: DeSerializersT = defaultDeSerializers as any): FunctionImportRequestBuilder<DeSerializersT, ReturnIntParameters<DeSerializersT>, number | null> {
  const params = {
 ...
 * @returns A request builder that allows to overwrite some of the values and execute the resulting request.
 */
export function getByKey<DeSerializersT extends DeSerializers = DefaultDeSerializers>(parameters: GetByKeyParameters<DeSerializersT>, deSerializers: DeSerializersT = defaultDeSerializers as any): FunctionImportRequestBuilder<DeSerializersT, GetByKeyParameters<DeSerializersT>, TestEntity | null> {
  const params = {
    param: new FunctionImportParameter('param', 'Edm.Int32', parameters.param)
  };


  return new FunctionImportRequestBuilder('/odata/test-service', 'getByKey', (data) => transformReturnValueForEntity(data, boundTestService(deSerializers).testEntityApi), params, deSerializers);
}
...
export function getAll<DeSerializersT extends DeSerializers = DefaultDeSerializers>(parameters: GetAllParameters<DeSerializersT>, deSerializers: DeSerializersT = defaultDeSerializers as any): FunctionImportRequestBuilder<DeSerializersT, GetAllParameters<DeSerializersT>, TestEntity[]> {
  ...
  return new FunctionImportRequestBuilder('/odata/test-service', 'getAll', (data) => transformReturnValueForEntityList(data, boundTestService(deSerializers).testEntityApi), params, deSerializers);
}
