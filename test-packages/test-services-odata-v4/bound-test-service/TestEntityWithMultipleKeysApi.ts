...
export class TestEntityWithMultipleKeysApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
  ...
  requestBuilder(): TestEntityWithMultipleKeysRequestBuilder<
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<typeof TestEntityWithMultipleKeys, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(TestEntityWithMultipleKeys, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    KEY_TEST_ENTITY_WITH_MULTIPLE_KEYS: OrderableEdmTypeField<TestEntityWithMultipleKeys<DeSerializers>, DeSerializersT, 'Edm.Int32', false, true>,
STRING_PROPERTY_WITH_MULTIPLE_KEYS: OrderableEdmTypeField<TestEntityWithMultipleKeys<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BOOLEAN_PROPERTY_WITH_MULTIPLE_KEYS: OrderableEdmTypeField<TestEntityWithMultipleKeys<DeSerializers>, DeSerializersT, 'Edm.Boolean', false, true>,
