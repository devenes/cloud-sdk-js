...
export function changeset<DeSerializersT extends DeSerializers>(
  first:
    | undefined
    | WriteBoundTestServiceRequestBuilder<DeSerializersT>
    | Array<WriteBoundTestServiceRequestBuilder<DeSerializersT>>,
  ...rest: Array<WriteBoundTestServiceRequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT> {
