...
exports.boundTestService = void 0;
/*
...
function boundTestService(deSerializers = odata_v4_1.defaultDeSerializers) {
    return new BoundTestService((0, odata_v4_1.mergeDefaultDeSerializersWith)(deSerializers));
}
exports.boundTestService = boundTestService;
class BoundTestService {
