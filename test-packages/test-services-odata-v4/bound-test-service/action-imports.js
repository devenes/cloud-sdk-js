...
function createTestEntityById(parameters, deSerializers = odata_v4_1.defaultDeSerializers) {
    ...
    return new odata_v4_1.ActionImportRequestBuilder('/odata/test-service', 'createTestEntityById', (data) => (0, odata_v4_1.transformReturnValueForEntity)(data, (0, service_1.boundTestService)(deSerializers).testEntityApi), params, deSerializers);
}
