...
import { CustomField, defaultDeSerializers, DefaultDeSerializers, DeSerializers, AllFields, entityBuilder, EntityBuilderType, EntityApi, FieldBuilder, OrderableEdmTypeField, EnumField } from '@sap-cloud-sdk/odata-v4';
export class TestEntity1Api<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _schema?: {
    KEY_PROPERTY_STRING: OrderableEdmTypeField<TestEntity1<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
INT_16_PROPERTY: OrderableEdmTypeField<TestEntity1<DeSerializers>, DeSerializersT, 'Edm.Int16', true, true>,
ENUM_PROPERTY: EnumField<TestEntity1<DeSerializers>, DeSerializersT, TestEnumType1, true, true>,
COMPLEX_TYPE_PROPERTY: TestComplexType1Field<TestEntity1<DeSerializers>, DeSerializersT, true, true>,
