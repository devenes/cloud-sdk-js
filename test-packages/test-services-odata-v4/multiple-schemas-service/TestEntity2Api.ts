...
export class TestEntity2Api<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _schema?: {
    KEY_PROPERTY_STRING: OrderableEdmTypeField<TestEntity2<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
SINGLE_PROPERTY: OrderableEdmTypeField<TestEntity2<DeSerializers>, DeSerializersT, 'Edm.Single', true, true>,
