...
export class TestEntity3Api<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _schema?: {
    KEY_PROPERTY_STRING: OrderableEdmTypeField<TestEntity3<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
ENUM_PROPERTY: EnumField<TestEntity3<DeSerializers>, DeSerializersT, TestEnumType2, true, true>,
COMPLEX_TYPE_PROPERTY: TestComplexType2Field<TestEntity3<DeSerializers>, DeSerializersT, true, true>,
