 ...
 */
export class TestEntity4RequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<TestEntity4<T>, T> {
  /**
  ...
  getByKey(keyPropertyString: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<TestEntity4<T>, T> {
    return new GetByKeyRequestBuilder<TestEntity4<T>, T>(this.entityApi, { KeyPropertyString: keyPropertyString });
  }
  ...
  delete(keyPropertyStringOrEntity: any): DeleteRequestBuilder<TestEntity4<T>, T> {
    return new DeleteRequestBuilder<TestEntity4<T>, T>(this.entityApi, keyPropertyStringOrEntity instanceof TestEntity4 ? keyPropertyStringOrEntity : { KeyPropertyString: keyPropertyStringOrEntity! });
  }
}
