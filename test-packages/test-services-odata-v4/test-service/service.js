...
class TestService {
    ...
    get functionImports() {
        return { testFunctionImportEdmReturnType: (parameter) => (0, function_imports_1.testFunctionImportEdmReturnType)(parameter, this.deSerializers), testFunctionImportEdmReturnTypeCollection: (parameter) => (0, function_imports_1.testFunctionImportEdmReturnTypeCollection)(parameter, this.deSerializers), testFunctionImportNullableTest: (parameter) => (0, function_imports_1.testFunctionImportNullableTest)(parameter, this.deSerializers), testFunctionImportEntityReturnType: (parameter) => (0, function_imports_1.testFunctionImportEntityReturnType)(parameter, this.deSerializers), testFunctionImportEntityReturnTypeCollection: (parameter) => (0, function_imports_1.testFunctionImportEntityReturnTypeCollection)(parameter, this.deSerializers), testFunctionImportSharedEntityReturnType: (parameter) => (0, function_imports_1.testFunctionImportSharedEntityReturnType)(parameter, this.deSerializers), testFunctionImportSharedEntityReturnTypeCollection: (parameter) => (0, function_imports_1.testFunctionImportSharedEntityReturnTypeCollection)(parameter, this.deSerializers), testFunctionImportComplexReturnType: (parameter) => (0, function_imports_1.testFunctionImportComplexReturnType)(parameter, this.deSerializers), testFunctionImportComplexReturnTypeCollection: (parameter) => (0, function_imports_1.testFunctionImportComplexReturnTypeCollection)(parameter, this.deSerializers), testFunctionImportMultipleParams: (parameter) => (0, function_imports_1.testFunctionImportMultipleParams)(parameter, this.deSerializers), testFunctionImportWithDifferentName: (parameter) => (0, function_imports_1.testFunctionImportWithDifferentName)(parameter, this.deSerializers) };
    }
    get actionImports() {
        return { testActionImportNoParameterNoReturnType: (parameter) => (0, action_imports_1.testActionImportNoParameterNoReturnType)(parameter, this.deSerializers), testActionImportMultipleParameterComplexReturnType: (parameter) => (0, action_imports_1.testActionImportMultipleParameterComplexReturnType)(parameter, this.deSerializers), testActionImportUnsupportedEdmTypes: (parameter) => (0, action_imports_1.testActionImportUnsupportedEdmTypes)(parameter, this.deSerializers), testActionImportNoParameterEntityReturnType: (parameter) => (0, action_imports_1.testActionImportNoParameterEntityReturnType)(parameter, this.deSerializers), testActionImportSharedEntityReturnType: (parameter) => (0, action_imports_1.testActionImportSharedEntityReturnType)(parameter, this.deSerializers), testActionImportSharedEntityReturnTypeCollection: (parameter) => (0, action_imports_1.testActionImportSharedEntityReturnTypeCollection)(parameter, this.deSerializers), testActionImportNullableTest: (parameter) => (0, action_imports_1.testActionImportNullableTest)(parameter, this.deSerializers) };
    }
    get batch() {
