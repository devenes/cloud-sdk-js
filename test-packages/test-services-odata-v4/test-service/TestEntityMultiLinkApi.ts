...
export class TestEntityMultiLinkApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof TestEntityMultiLink, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(TestEntityMultiLink, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    STRING_PROPERTY: OrderableEdmTypeField<TestEntityMultiLink<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BOOLEAN_PROPERTY: OrderableEdmTypeField<TestEntityMultiLink<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
GUID_PROPERTY: OrderableEdmTypeField<TestEntityMultiLink<DeSerializers>, DeSerializersT, 'Edm.Guid', true, true>,
INT_16_PROPERTY: OrderableEdmTypeField<TestEntityMultiLink<DeSerializers>, DeSerializersT, 'Edm.Int16', true, true>,
KEY_PROPERTY: OrderableEdmTypeField<TestEntityMultiLink<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
/**
 * Static representation of the one-to-many navigation property {@link toMultiLink1} for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */
