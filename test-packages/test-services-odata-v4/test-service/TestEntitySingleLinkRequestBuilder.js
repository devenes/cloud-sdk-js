...
class TestEntitySingleLinkRequestBuilder extends odata_v4_1.RequestBuilder {
    ...
    delete(keyPropertyOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(this.entityApi, keyPropertyOrEntity instanceof TestEntitySingleLink_1.TestEntitySingleLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    }
}
