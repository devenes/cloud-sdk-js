...
class TestEntityEndsWithSomethingElseRequestBuilder extends odata_v4_1.RequestBuilder {
    ...
    delete(keyPropertyOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(this.entityApi, keyPropertyOrEntity instanceof TestEntityEndsWithSomethingElse_1.TestEntityEndsWithSomethingElse ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    }
}
