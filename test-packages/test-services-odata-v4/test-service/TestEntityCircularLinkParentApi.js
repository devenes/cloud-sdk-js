...
class TestEntityCircularLinkParentApi {
    ...
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            TO_FIRST_CHILD: new odata_v4_1.OneToOneLink('to_FirstChild', this, linkedApis[0]),
            TO_CHILDREN: new odata_v4_1.OneToManyLink('to_Children', this, linkedApis[1])
        };
        return this;
    }
    requestBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v4_1.FieldBuilder(TestEntityCircularLinkParent_1.TestEntityCircularLinkParent, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
             ...
             */
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v4_1.AllFields('*', TestEntityCircularLinkParent_1.TestEntityCircularLinkParent)
            };
        }
        return this._schema;
    }
