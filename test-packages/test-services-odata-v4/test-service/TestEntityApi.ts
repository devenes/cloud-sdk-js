...
import { CustomField, defaultDeSerializers, DefaultDeSerializers, DeSerializers, AllFields, entityBuilder, EntityBuilderType, EntityApi, FieldBuilder, Time, OrderableEdmTypeField, EdmTypeField, CollectionField, EnumField, OneToManyLink, OneToOneLink } from '@sap-cloud-sdk/odata-v4';
export class TestEntityApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  _addNavigationProperties(
      linkedApis: [
        TestEntityMultiLinkApi<DeSerializersT>,TestEntityMultiLinkApi<DeSerializersT>,TestEntitySingleLinkApi<DeSerializersT>
      ]): this {
  ...
  private _schema?: {
    KEY_PROPERTY_GUID: OrderableEdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.Guid', false, true>,
KEY_PROPERTY_STRING: OrderableEdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
...
INT_16_PROPERTY: OrderableEdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.Int16', true, true>,
INT_32_PROPERTY: OrderableEdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.Int32', true, true>,
...
SINGLE_PROPERTY: OrderableEdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.Single', true, true>,
DOUBLE_PROPERTY: OrderableEdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.Double', true, true>,
FLOAT_PROPERTY: OrderableEdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.Float', true, true>,
...
DATE_TIME_OFF_SET_PROPERTY: OrderableEdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
DURATION_PROPERTY: OrderableEdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.Duration', true, true>,
BYTE_PROPERTY: OrderableEdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.Byte', true, true>,
S_BYTE_PROPERTY: OrderableEdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.SByte', true, true>,
GEOGRAPHY_POINT_PROPERTY: EdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.Any', true, true>,
SOMETHING_THE_SDK_DOES_NOT_SUPPORT: EdmTypeField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.Any', true, true>,
COLLECTION_PROPERTY: CollectionField<TestEntity<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
COMPLEX_TYPE_PROPERTY: TestComplexTypeField<TestEntity<DeSerializers>, DeSerializersT, true, true>,
COMPLEX_TYPE_COLLECTION_PROPERTY: CollectionField<TestEntity<DeSerializers>, DeSerializersT, TestComplexType, true, true>,
ENUM_PROPERTY: EnumField<TestEntity<DeSerializers>, DeSerializersT, TestEnumType, true, true>,
ENUM_PROPERTY_INT_64: EnumField<TestEntity<DeSerializers>, DeSerializersT, TestEnumTypeInt64, true, true>,
ENUM_PROPERTY_WITH_ONE_MEMBER: EnumField<TestEntity<DeSerializers>, DeSerializersT, TestEnumTypeWithOneMember, true, true>,
ENUM_COLLECTION_PROPERTY: CollectionField<TestEntity<DeSerializers>, DeSerializersT, typeof TestEnumType, true, true>,
/**
 * Static representation of the one-to-many navigation property {@link toMultiLink} for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */
 ...
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */
COMPLEX_TYPE_COLLECTION_PROPERTY: fieldBuilder.buildCollectionField('ComplexTypeCollectionProperty', TestComplexType, true),
/**
 * Static representation of the {@link enumProperty} property for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */
ENUM_PROPERTY: fieldBuilder.buildEnumField('EnumProperty', TestEnumType, true),
/**
 * Static representation of the {@link enumPropertyInt64} property for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */
ENUM_PROPERTY_INT_64: fieldBuilder.buildEnumField('EnumPropertyInt64', TestEnumTypeInt64, true),
/**
 * Static representation of the {@link enumPropertyWithOneMember} property for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */
ENUM_PROPERTY_WITH_ONE_MEMBER: fieldBuilder.buildEnumField('EnumPropertyWithOneMember', TestEnumTypeWithOneMember, true),
/**
 * Static representation of the {@link enumCollectionProperty} property for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */
ENUM_COLLECTION_PROPERTY: fieldBuilder.buildCollectionField('EnumCollectionProperty', TestEnumType, true),
...this.navigationPropertyFields,
/**
 * 
 * All fields selector.
