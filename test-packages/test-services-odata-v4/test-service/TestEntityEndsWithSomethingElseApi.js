...
class TestEntityEndsWithSomethingElseApi {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v4_1.FieldBuilder(TestEntityEndsWithSomethingElse_1.TestEntityEndsWithSomethingElse, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
             ...
             */
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v4_1.AllFields('*', TestEntityEndsWithSomethingElse_1.TestEntityEndsWithSomethingElse)
            };
        }
        return this._schema;
    }
