...
import { CustomField, defaultDeSerializers, DefaultDeSerializers, DeSerializers, AllFields, entityBuilder, EntityBuilderType, EntityApi, FieldBuilder, EnumField } from '@sap-cloud-sdk/odata-v4';
export class TestEntityWithEnumKeyApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof TestEntityWithEnumKey, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(TestEntityWithEnumKey, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    KEY_PROPERTY_ENUM_1: EnumField<TestEntityWithEnumKey<DeSerializers>, DeSerializersT, TestEnumType, false, true>,
