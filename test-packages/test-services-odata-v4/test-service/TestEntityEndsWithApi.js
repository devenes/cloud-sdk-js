...
class TestEntityEndsWithApi {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v4_1.FieldBuilder(TestEntityEndsWith_1.TestEntityEndsWith, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
             ...
             */
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v4_1.AllFields('*', TestEntityEndsWith_1.TestEntityEndsWith)
            };
        }
        return this._schema;
    }
