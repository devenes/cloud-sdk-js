...
class TestEntityWithSharedEntityType1Api {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v4_1.FieldBuilder(TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
             ...
             */
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v4_1.AllFields('*', TestEntityWithSharedEntityType1_1.TestEntityWithSharedEntityType1)
            };
        }
        return this._schema;
    }
