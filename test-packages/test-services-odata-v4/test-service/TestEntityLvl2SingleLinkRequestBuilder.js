 ...
 */
class TestEntityLvl2SingleLinkRequestBuilder extends odata_v4_1.RequestBuilder {
    /**
    ...
    delete(keyPropertyOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(this.entityApi, keyPropertyOrEntity instanceof TestEntityLvl2SingleLink_1.TestEntityLvl2SingleLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    }
}
