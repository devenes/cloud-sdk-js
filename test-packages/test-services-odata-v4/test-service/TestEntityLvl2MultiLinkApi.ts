...
import { CustomField, defaultDeSerializers, DefaultDeSerializers, DeSerializers, AllFields, entityBuilder, EntityBuilderType, EntityApi, FieldBuilder, OrderableEdmTypeField, OneToManyLink } from '@sap-cloud-sdk/odata-v4';
export class TestEntityLvl2MultiLinkApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof TestEntityLvl2MultiLink, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(TestEntityLvl2MultiLink, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    STRING_PROPERTY: OrderableEdmTypeField<TestEntityLvl2MultiLink<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BOOLEAN_PROPERTY: OrderableEdmTypeField<TestEntityLvl2MultiLink<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
GUID_PROPERTY: OrderableEdmTypeField<TestEntityLvl2MultiLink<DeSerializers>, DeSerializersT, 'Edm.Guid', true, true>,
INT_16_PROPERTY: OrderableEdmTypeField<TestEntityLvl2MultiLink<DeSerializers>, DeSerializersT, 'Edm.Int16', true, true>,
KEY_PROPERTY: OrderableEdmTypeField<TestEntityLvl2MultiLink<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
/**
 * Static representation of the one-to-many navigation property {@link toMultiLink2} for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */
