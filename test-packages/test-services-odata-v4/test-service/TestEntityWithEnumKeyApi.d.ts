...
import { CustomField, DefaultDeSerializers, DeSerializers, AllFields, EntityBuilderType, EntityApi, FieldBuilder, EnumField } from '@sap-cloud-sdk/odata-v4';
export declare class TestEntityWithEnumKeyApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements EntityApi<TestEntityWithEnumKey<DeSerializersT>, DeSerializersT> {
    ...
    get fieldBuilder(): FieldBuilder<typeof TestEntityWithEnumKey, DeSerializersT>;
    private _schema?;
    get schema(): {
