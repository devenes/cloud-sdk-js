 ...
 */
class TestEntityLvl3MultiLinkRequestBuilder extends odata_v4_1.RequestBuilder {
    /**
    ...
    delete(keyPropertyOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(this.entityApi, keyPropertyOrEntity instanceof TestEntityLvl3MultiLink_1.TestEntityLvl3MultiLink ? keyPropertyOrEntity : { KeyProperty: keyPropertyOrEntity });
    }
}
exports.TestEntityLvl3MultiLinkRequestBuilder = TestEntityLvl3MultiLinkRequestBuilder;
