...
export class TestEntityLvl2SingleLinkApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
  ...
  requestBuilder(): TestEntityLvl2SingleLinkRequestBuilder<
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<typeof TestEntityLvl2SingleLink, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(TestEntityLvl2SingleLink, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    STRING_PROPERTY: OrderableEdmTypeField<TestEntityLvl2SingleLink<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BOOLEAN_PROPERTY: OrderableEdmTypeField<TestEntityLvl2SingleLink<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
GUID_PROPERTY: OrderableEdmTypeField<TestEntityLvl2SingleLink<DeSerializers>, DeSerializersT, 'Edm.Guid', true, true>,
INT_16_PROPERTY: OrderableEdmTypeField<TestEntityLvl2SingleLink<DeSerializers>, DeSerializersT, 'Edm.Int16', true, true>,
KEY_PROPERTY: OrderableEdmTypeField<TestEntityLvl2SingleLink<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
