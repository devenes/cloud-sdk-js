...
import { CustomField, defaultDeSerializers, DefaultDeSerializers, DeSerializers, AllFields, entityBuilder, EntityBuilderType, EntityApi, FieldBuilder, OrderableEdmTypeField, OneToManyLink, OneToOneLink } from '@sap-cloud-sdk/odata-v4';
export class TestEntitySingleLinkApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
  ...
  private _fieldBuilder?: FieldBuilder<typeof TestEntitySingleLink, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(TestEntitySingleLink, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    STRING_PROPERTY: OrderableEdmTypeField<TestEntitySingleLink<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BOOLEAN_PROPERTY: OrderableEdmTypeField<TestEntitySingleLink<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
GUID_PROPERTY: OrderableEdmTypeField<TestEntitySingleLink<DeSerializers>, DeSerializersT, 'Edm.Guid', true, true>,
INT_16_PROPERTY: OrderableEdmTypeField<TestEntitySingleLink<DeSerializers>, DeSerializersT, 'Edm.Int16', true, true>,
KEY_PROPERTY: OrderableEdmTypeField<TestEntitySingleLink<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
/**
 * Static representation of the one-to-many navigation property {@link toMultiLink} for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */
