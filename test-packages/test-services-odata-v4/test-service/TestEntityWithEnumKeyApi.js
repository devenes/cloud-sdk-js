...
class TestEntityWithEnumKeyApi {
    ...
    get schema() {
        if (!this._schema) {
             ...
             */
                KEY_PROPERTY_ENUM_1: fieldBuilder.buildEnumField('KeyPropertyEnum1', TestEnumType_1.TestEnumType, false),
                ...this.navigationPropertyFields,
                /**
                 *
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v4_1.AllFields('*', TestEntityWithEnumKey_1.TestEntityWithEnumKey)
            };
        }
        return this._schema;
    }
